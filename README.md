...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-j-de7li.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-j-de7li.containers.anotherwebservice.com/
...
```
git clone git@github.com:Srinath-R1/container-j-de7li.git
cd container-j-de7li
```
...
```
docker attach container-j-de7li
```
